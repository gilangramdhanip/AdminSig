...
import kotlinx.android.synthetic.main.list_item.view.iv_home
import kotlinx.android.synthetic.main.list_item.view.txv_cat
import kotlinx.android.synthetic.main.list_item.view.txv_dest_desc
import kotlinx.android.synthetic.main.list_verify.view.*
import kotlin.coroutines.coroutineContext


class VerificationAdapter(private val destinationList: ArrayList<Destination>): RecyclerView.Adapter<VerificationAdapter.ListViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_verify, parent, false)
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(destination: Destination) {
            with(itemView){
                txv_verif_name.text = destination.name_destination
                txv_verif_desc.text = destination.desc_destination
                txv_verif_cat.text = destination.id_kategori

                if(destination.img_destination == ""){
                    verif_home.setImageResource(R.drawable.undraw_journey_lwlj)
                }else{
                    Glide.with(context)
